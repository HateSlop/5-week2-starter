...
- 제출 파일은 `IDEA.md`와 `app.py`입니다. 필요하면 같은 폴더에 짧은 `README.md`를 추가할 수 있습니다.
...
웹 화면, 새 패키지, 데이터베이스, 배포가 필요한 아이디어는 이 과제 Pull Request에 붙이지 않습니다. 먼저 이 과제의 작은 버전을 제출하고, 확장 버전은 별도 개인 저장소에서 진행합니다.
